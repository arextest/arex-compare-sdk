...
//    sdk.getGlobalOptions().putOnlyCompareExistListElements(true);
  ...
  public void testMultiCompare() {
    String baseMsg = "{\n"
        ...
        + "        {}\n"
        + "    ],\n"
        + "    \"body\": \"select * from orderpromotion where OrderID = 36044115664;select * from flightgift where OrderID = 36044115664;select * from flightorderstatistics where OrderID = 36044115664;select * from flighttransitvisaformat where OrderID = 36044115664;select * from ordercontact where OrderID = 36044115664;select * from xrelation where OrderID = 36044115664;select * from flightprice where OrderID = 36044115664;select * from flightorder where OrderID = 36044115664;select * from orderpackage where OrderID = 36044115664;select * from orderpayment where OrderID = 36044115664;select * from flights where OrderID = 36044115664;select * from xdetail where OrderID = 36044115664;select * from flightreservation where OrderID = 36044115664;select * from flightstop where OrderID = 36044115664;select * from flightdomesticprice where OrderID = 36044115664;select * from xproductactivity where OrderID = 36044115664;select * from orderadditionalinfo where OrderID = 36044115664;select * from orderinvoice where OrderID = 36044115664;select * from orders where OrderID = 36044115664;select * from flightrelation where OrderID = 36044115664;select * from flightpassengerrelation where OrderID = 36044115664;select * from orderforeignprice where OrderID = 36044115664;select * from flightmembercard where OrderID = 36044115664;select * from orderalliance where OrderID = 36044115664;select * from flightcorp where OrderID = 36044115664;select * from flightpackageattachment where OrderID = 36044115664;select * from flightadditionalinfo where OrderID = 36044115664;select * from xpolicyholder where OrderID = 36044115664;select * from orderinterestsusage where OrderID = 36044115664;select * from flightpnr where OrderID = 36044115664;select * from orderpassenger where OrderID = 36044115664;select * from ordercashback where OrderID = 36044115664;select * from orderdeduction where OrderID = 36044115664;select * from orderremark where OrderID = 36044115664;select * from orderpackagerelation where OrderID = 36044115664;select * from orderdelivery where OrderID = 36044115664;\",\n"
        + "    \"dbname\": \"fltdombookingdb_W\"\n"
        + "}";
    String testMsg = "{\n"
        + "    \"parameters\": [\n"
        + "        {}\n"
        + "    ],\n"
        + "    \"body\": \"select * from orderdeduction where OrderID = 36044115664;select * from flightrelation where OrderID = 36044115664;select * from orderpromotion where OrderID = 36044115664;select * from orders where OrderID = 36044115664;select * from flightcorp where OrderID = 36044115664;select * from flightstop where OrderID = 36044115664;select * from ordercontact where OrderID = 36044115664;select * from xdetail where OrderID = 36044115664;select * from orderpayment where OrderID = 36044115664;select * from ordercashback where OrderID = 36044115664;select * from flights where OrderID = 36044115664;select * from flightpnr where OrderID = 36044115664;select * from orderforeignprice where OrderID = 36044115664;select * from flightadditionalinfo where OrderID = 36044115664;select * from flightpassengerrelation where OrderID = 36044115664;select * from orderpackagerelation where OrderID = 36044115664;select * from flightmembercard where OrderID = 36044115664;select * from flightdomesticprice where OrderID = 36044115664;select * from xproductactivity where OrderID = 36044115664;select * from flighttransitvisaformat where OrderID = 36044115664;select * from flightprice where OrderID = 36044115664;select * from orderdelivery where OrderID = 36044115664;select * from flightpackageattachment where OrderID = 36044115664;select * from orderinvoice where OrderID = 36044115664;select * from xpolicyholder where OrderID = 36044115664;select * from flightorder where OrderID = 36044115664;select * from orderinterestsusage where OrderID = 36044115664;select * from orderremark where OrderID = 36044115664;select * from orderpackage where OrderID = 36044115664;select * from orderadditionalinfo where OrderID = 36044115664;select * from orderpassenger where OrderID = 36044115664;select * from flightreservation where OrderID = 36044115664;select * from flightgift where OrderID = 36044115664;select * from xrelation where OrderID = 36044115664;select * from orderalliance where OrderID = 36044115664;select * from flightorderstatistics where OrderID = 36044115664;\",\n"
        + "    \"dbname\": \"fltdombookingdb_W\"\n"
        + "}";
    CompareSDK sdk = new CompareSDK();
    CompareOptions compareOptions = CompareOptions.options()
