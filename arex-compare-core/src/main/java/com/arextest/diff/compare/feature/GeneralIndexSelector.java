...
public class GeneralIndexSelector implements IndexSelector {
    ...
    @Override
    public int findCorrespondLeftIndex(int curRightIndex, List<Integer> leftComparedIndex, ArrayNode obj1Array, ArrayNode obj2Array) {
    ...
    @Override
    public int findCorrespondRightIndex(int curLeftIndex, List<Integer> rightComparedIndex, ArrayNode obj1Array, ArrayNode obj2Array) {
