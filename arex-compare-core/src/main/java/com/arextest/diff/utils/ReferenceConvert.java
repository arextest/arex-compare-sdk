...
public class ReferenceConvert {
  ...
  public static List<ReferenceEntity> getAllReferenceEntities(
      List<ResponseNodeReferenceEntity> responseNodeReferenceEntities) {
  ...
  public static List<ListSortEntity> getKeyConfig(List<ResponseListKeyEntity> keyEntities,
