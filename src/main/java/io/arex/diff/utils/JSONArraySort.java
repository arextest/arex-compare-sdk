...
import io.arex.diff.model.key.RatioEntity;
...
public class JSONArraySort {
    ...
    public static void jsonArraySortSplitWhole(List<String> firstArray, List<String> secondArray, float simThreshold) {
